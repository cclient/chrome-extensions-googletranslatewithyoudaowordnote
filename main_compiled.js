...
(function () {
    ...
    var ma = "StopIteration" in h ? h.StopIteration : {message: "StopIteration", stack: ""}, na = function () {
    };
    ...
    }, pa = "constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" "), qa = function (a, b) {
    ...
    var v = function (a, b) {
        ...
        if (1 < c) {
            ...
            var e;
            if (a instanceof v)e = a.s(), d = a.o(); else {
                var c = [], f = 0;
                for (e in a)c[f++] = e;
                e = c;
                c = [];
    ...
    v.prototype.g = function (a) {
        w(this);
        var b = 0, c = this.f, d = this, e = new na;
        e.next = function () {
    ...
    }, wa = /[#\/\?@]/g, ya = /[\#\?:]/g, xa = /[\#\?]/g, Ba = /[\#\?@]/g, za = /#/g, B = function (a, b, c) {
        this.c = this.a = null;
        this.b = a || null;
        this.f = !!c
    }, D = function (a) {
    ...
    B.prototype.s = function () {
        D(this);
        for (var a = this.a.o(), b = this.a.s(), c = [], d = 0; d < b.length; d++)for (var e = a[d], f = 0; f < e.length; f++)c.push(b[d]);
        return c
    };
    B.prototype.o = function (a) {
        D(this);
        var b = [];
        if ("string" == typeof a)Fa(this, a) && (b = ka(b, this.a.get(E(this, a)))); else {
            a = this.a.o();
    ...
    B.prototype.toString = function () {
        ...
        if (!this.a)return "";
        for (var a = [], b = this.a.s(), c = 0; c < b.length; c++)for (var d = b[c], e = encodeURIComponent(String(d)), d = this.o(d), f = 0; f < d.length; f++) {
            var g = e;
    ...
    var Ia = G("Opera") || G("OPR"), H = G("Trident") || G("MSIE"), Ja = G("Edge"), Ka = G("Gecko") && !(-1 != F.toLowerCase().indexOf("webkit") && !G("Edge")) && !(G("Trident") || G("MSIE")) && !G("Edge"), La = -1 != F.toLowerCase().indexOf("webkit") && !G("Edge"), Ma = function () {
        var a = F;
        ...
        if (!Pa[a]) {
            for (var b = 0, c = fa(String(Oa)).split("."), d = fa(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                var g = c[f] || "", k = d[f] || "", r = RegExp("(\\d*)(\\D*)", "g"), A = RegExp("(\\d*)(\\D*)", "g");
                do {
                    var N = r.exec(g) || ["", "", ""], O = A.exec(k) || ["", "", ""];
    ...
    }, Ra = h.document, Sa = Ra && H ? Na() || ("CSS1Compat" == Ra.compatMode ? parseInt(Oa, 10) : 5) : void 0;
    var Ta;
    if (!(Ta = !Ka && !H)) {
        var Ua;
        if (Ua = H)Ua = 9 <= Sa;
    ...
    var J = function (a, b, c) {
        if (0 == a.a) {
            ...
            a:{
                var e = c, f = a.m, g = a.u;
                if (e instanceof L)null != f && u(f, "opt_onFulfilled should be a function."), null != g && u(g, "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"), tb(e, nb(f || l, g || null, a)), d = !0; else if (kb(e))e.then(f, g, a), d = !0; else {
                    var k = typeof e;
    ...
    M.prototype.cancel = function (a) {
        if (this.a)this.c instanceof M && this.c.cancel(); else {
            if (this.b) {
                var b = this.b;
                delete this.b;
    ...
    var Jb = function (a, b) {
        var c = b || {}, d = c.document || document, e = document.createElement("SCRIPT"), f = {
            F: e,
            v: void 0
        }, g = new M(Gb, f), k = null, r = null != c.timeout ? c.timeout : 5E3;
    ...
    Kb.prototype.send = function (a, b, c, d) {
        ...
        var e = this.b.clone();
        if (a)for (var f in a)a.hasOwnProperty && !a.hasOwnProperty(f) || Da(e, f, a[f]);
    ...
    var Wb = T("(function(){({{$code}})();})();", {code: window.injection.toString()}), Xb = T("(function(){({{$code}})();})();", {code: window.injector.toString()});
    ...
    var $b = new V, Tb = new U(!0), W = document.createElement("audio");
    ...
    var ac = function () {
        return $b
    }, X = ["translate", "getTranslateManager"], Y = h;
